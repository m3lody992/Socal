        ...
        viewModel.onLimitReached = { [weak self] in
            ...
            self?.GPDA7xAfrmUstbwkNL8w8L28c51RQ5GI {
                if UserNotificationsService.isNotificationSet == false {
                    PresentScheduledNotificationService.addNotificationAndPresent(.init(title: "Daily limit reached.", message: "We currently only allow 100 likes per day. Check back soon!", buttons: [.okDismiss]) {
