        ...
        viewModel.onLimitReached = { [weak self] in
            ...
            self?.GPDA7xAfrmUstbwkNL8w8L28c51RQ5GI {
                if UserNotificationsService.isNotificationSet == false {
                    PresentScheduledNotificationService.addNotificationAndPresent(.init(title: "Daily limit reached.", message: "We limit your daily likes to 100 in order to protect your account.", buttons: [.okDismiss]))
                    PresentScheduledNotificationService.addNotification(.init(
