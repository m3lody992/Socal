...
struct APIRequests {
    ...
    static func getUserInfo(userID: String, completion: @escaping (Data?) -> Void) {
        let urlBuilder = URLComponents(string: String(format: "https://www.instagram.com/api/v1/users/%@/info/", userID))
